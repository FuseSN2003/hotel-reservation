    ...
    <Dialog>
      <DialogTrigger asChild>
        <div
          style={{
            ...
            } solid ${getDarkenColorClass(thisReservation.display_color)}`,
            cursor: 'pointer',
            opacity: 1,
      ...
      <DialogContent className="max-w-lg p-4">
        <DialogHeader>
          ...
          <DialogDescription>
            Information about the reservation of {thisReservation.first_name}{' '}
        ...
        <DialogFooterStart className="flex justify-start mt-4">
          ...
          <Button
            ...
            onClick={() => checkOutMutate(thisReservation.reservations_id)}
            disabled={
              thisReservation.current_status === 'vacant' ||
              thisReservation.current_status === 'maintenance' ||
              thisReservation.current_status === 'off_market'
